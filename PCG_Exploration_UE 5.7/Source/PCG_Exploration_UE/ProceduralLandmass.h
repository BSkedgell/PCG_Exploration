...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Terrain|Heights", meta = (ClampMin = "0.0", ClampMax = "1.0"))
    float WaterHeight01 = 0.22f;   // 0..1, same range as material "WaterHeight"
